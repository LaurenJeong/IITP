(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new View("viewMaster","10","viewButton:6",null,"196","10",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("viewMaster");
            obj.set_viewdataset("viewdataset");
            this.addChild(obj.name, obj);

            obj = new View("viewDetail","10","viewMaster:10",null,null,"10","10",null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.addIncludeScript("sample_MasterDetailV.xfdl","lib::libCommon.xjs");
        this.registerScript("sample_MasterDetailV.xfdl", function() {
        /**
        *  @MenuPath    샘플 > OO관리
        ...
        **************************************************************************/
        ...
        this.loadIncludeScript("sample_MasterDetailV.xfdl");
