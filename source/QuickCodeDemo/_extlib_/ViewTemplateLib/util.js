...
(function()
{
    ...
    //{
        ...
        ************************************************************************************************/
         ...
         * @example
         * var bNull = lfn_IsNull("aaa");	// false
         */
        lfn_IsNull = function(sValue)
        {
         ...
         * @return	{Boolean} true/false
         * @example
         * var bNotNull = lfn_IsNotNull("aaa");	// true
         */
        lfn_IsNotNull = function(sValue)
        {
        	if (lfn_IsNull(sValue))
        		return false;
        	else
        		return true;
        };
         ...
         * @example
         * var sEmpty = lfn_IsNullEmpty(null);	// ""
         */
        lfn_IsNullEmpty = function(sValue)
        {
            if (lfn_IsNull(sValue)) {
                return "";
            } else {
         ...
         */
        lfn_Nvl = function(inVal, nullVal)
        {
        	if(lfn_IsNull(inVal)) {
        		inVal = nullVal;
        	}
        ...
        */
        ...
        lfn_Decode = function ()
        {
        	...
        	var arrArgument = lfn_Decode.arguments;
         ...
         * @return {String} 문자열
         */
        lfn_Trim = function(sValue)
        {
            if (lfn_IsNull(sValue)) return "";
        ...
        */
         ...
         * @return {String} 결과값
         */
        lfn_Right = function(sOrg, nSize)
        {
        	if ( lfn_IsNull(sOrg) || lfn_IsNull(nSize) )	return "";
        ...
        lfn_LengthByte = function (sVal)
        {
        	...
        	for (var i = 0; i < sVal.length; i++)
        	{
        		...
        		*/
        		lengthByte += lfn_GetCharByteSize(sVal.substr(i,1));
        	}
        ...
        // UTF-8기준으로 글자수 반환
        lfn_GetCharByteSize = function(sChr)
        {
         ...
         * @return {Number}
         * @example
         * var nPos = lfn_PosReverse("aaBBbbccBB", "BB"); <br>
         * 성공 = 찾고자 하는 문자열의 시작위치 ( 예 : 8 ) <br>
         * 실패 = -1 <br>
         */
        lfn_PosReverse = function (sOrg, sFind, nStart)
        {
        	var pos;

        	if (lfn_IsNull(sOrg) || lfn_IsNull(sFind))
        	{
        		return -1;
        	}
        	if (lfn_IsNull(nStart))
        	{
         ...
         */
        lfn_AppendComma = function(nNumber,nDetail)
        {
         ...
         */
        lfn_RemoveComma = function(strValue)
        {
         ...
         * @return {String} 숫자문자열
         */
        lfn_GetDigit = function(strValue)
        {
         ...
         */
        lfn_RemoveSpecialChar = function(strValue)
        {
           var strSpecial = "~!@#$%^&*-+./=_`{|}()\\?<>";
   ...
   for (i = 0; i < strValue.length; i++) {
         ...
         * @return {String}
         * @example
         * var str = lfn_RemoveHtmlTag("정상적으로<BR>처리되었습니다.");
         */
        lfn_RemoveHtmlTag = function(sHtml, sTag)
        {
        	if(lfn_IsNull(sTag))
        	{
         ...
         */
        lfn_IsExistInArray = function(arrVal, varVal)
        {
        	var retVal = false;
        ...
        * @example
        * trace(lfn_TypeOf(Button00));	// output : Button
        * trace(lfn_TypeOf(Tab00));	// output : Tab
        * trace(lfn_TypeOf(Tab00.tabpage1));	// output : Tabpage
        * trace(lfn_TypeOf(Dataset00));	// output : Dataset
        */
        lfn_TypeOf = function(obj)
        {
        	var type;
         ...
         * @return {boolean}
         */
        lfn_IsNexaComponent = function(value)
        {
         ...
         * @return N/A
         */
        lfn_ObjView = function (objArg, sName)
        {
        	for (var name in objArg)
        	{
        		if (lfn_IsNull(sName) == false)
        		{
        			if (name == sName) {
         ...
         */
        lfn_StringifyJSON = function(obj)
        {
        	var oRet = {};
        	lfn_CopyProperties(oRet,obj);

        	oRet = this._lfn_SetExpJSON(oRet);
         ...
         * @return {Object} 변경된 값
         */
        this._lfn_SetExpJSON = function(obj)
        {
        	var oObj = obj;
        		...
        		if(Array.isArray(oObj)) {
        			if (oObj.length) {	// for array
        				for (var i = 0; i < oObj.length; i++) {
        					oObj[i] = this._lfn_SetExpJSON(oObj[i]);
        				}
        			}
        			...
        			for (var propName in oObj) {
        				if(typeof oObj[propName] === 'function' || oObj[propName] === undefined) {
        					...
        					oObj[propName] = this._lfn_SetExpJSON(oObj[propName]);
        				}
        			}
        		}
        	}
        			...
        			if(Array.isArray(obj)) {
        				...
        				for (var propName in obj) {
        					if(typeof obj[propName] === 'function' || obj[propName] === undefined) {
        						...
        						pstr += lfn_StringifyJSON(obj[propName]);
        					}
        				}
        				xstr += pstr + "}";
        			}
        ...
        */
         ...
         * @return  {Object} 오브젝트
         * @example
         * lfn_Lookup(this, "dsList");
         */
        lfn_Lookup = function(p, name)
        {
        	var o;
        	while (p)
        	{
         ...
         * var index = lfn_LastIndexOfProp(users, "name", "lee");
         * trace("index==>" + index);	// output : index==>6
         * var index = lfn_LastIndexOfProp(users, "name", "lee", 5);
         * trace("index==>" + index);	// output : index==>3
        */
        lfn_LastIndexOfProp = function(array, prop, item, from, strict)
        {
        	var i, obj,
        		propValue;
        ...
        */
        lfn_RemoveAt = function(array, index)
        {
        ...
        */
         ...
         * @return {String} id
         * @example
         * trace(lfn_GetUniqueI());
         * // output : 3e52d1f6-f0d2-4970-a590-ba7656b07859
         *
         * trace(lfn_GetUniqueI("Button_"));
         * // output : Button_4e601da1-63f4-4cfa-849b-01b8a7f14d40
         *
         * trace(lfn_GetUniqueI("", "_"));
         * // output : 4e601da1_63f4_4cfa_849b_01b8a7f14d40
         *
         * trace(lfn_GetUniqueId("Button_", "_"));
         * // output : Button_4e601da1_63f4_4cfa_849b_01b8a7f14d40
        */
        lfn_GetUniqueId = function(prefix, separator)
        {
        	if ( lfn_IsNull(prefix) ) prefix = "";
        	if ( lfn_IsNull(separator) ) {
        		separator = 45;
        	} else {
         ...
         * <--------------- 900 ------------------>
         *
         * trace(lfn_ConvertXY(this,[0,0], Button00)); //output: [900,300]
         * //Button00을 기준으로 한 0,0 좌표는
         * //form 기준으로 했을 때 900, 300이 된다.
        */
        lfn_ConvertXY = function(XCompA, xy, XCompB)
        {
        	var tempX, tempY;
        	var x, y;
        	if ( XCompB )
        	{
        		...
        		x = system.screenToClientX(XCompA, tempX) + lfn_GetScrollLeft(XCompA);
        		y = system.screenToClientY(XCompA, tempY) + lfn_GetScrollTop(XCompA);
        	}
        	else
        	{
        		x = xy[0];
         ...
         * @example
         * trace(lfn_GetScrollLeft(Div01)); //output: 10
         * trace(lfn_GetScrollLeft(Div01)); //output: 0
        */
        lfn_GetScrollLeft = function(XComp)
        {
         ...
         * @example
         * trace(lfn_GetScrollTop(Div01)); //output: 20
         * trace(lfn_GetScrollTop(Div01)); //output: 0
         */
        lfn_GetScrollTop = function(XComp)
        {
        	if(XComp instanceof nexacro.Div){
        		XComp = XComp.form;
        	}
         ...
         * @example
         * var target = {};
         * lfn_CopyProperties(target, {a: 1, b: "2", c: {"A": "3", "B": 4}});
         * for(var p in target)
         * {
         * 	trace(p + ":" + target[p]);
         *	// output : a:1
         ...
         * }
        */
        lfn_CopyProperties = function(tarobject, srcobject)
        {
         ...
         * @example
         * // this = Form
         * trace(lfn_GetSequenceId(this, "Button")); // output : Button0
         * trace(lfn_GetSequenceId(this, "Button")); // output : Button1
         * // this = Form
         * trace(lfn_GetSequenceId(this, "chk_")); // output : chk_0
         * trace(lfn_GetSequenceId(this, "chk_")); // output : chk_1
        */
        lfn_GetSequenceId = function(form, prefix)
        {
        	if ( lfn_IsNull(form) )
        	{
         ...
         * lfn_Each(datas, function(prop, val, object) {
         * 	var result = "";
         * 	if ( !val )
         * 	{
         ...
         * }, this);
        */
        lfn_Each = function(object, func, scope)
        {
        	var p,
        		scope = scope || object;
        	for (p in object)
         ...
         * @example
         * trace(lfn_GetTopLevelForm(this));	// output : [object Form]
        */
        lfn_GetTopLevelForm = function(curForm)
        {
        	var p = curForm;
         ...
         * @example
         * var mon = ["Jan","Feb","Mar","Apr"];
         * var contain = lfn_Contains(mon, "Mar");
         * trace("contain==>" + contain);	// output : contain==>true
         * var contain = lfn_Contains(mon, "May");
         * trace("contain==>" + contain);	// output : contain==>false
        */
        lfn_Contains = function(array, item, strict)
        {
        	if (lfn_IndexOf(array, item, null, strict) === -1)
        	{
        		return false;
        	}
        	else
         ...
         * @example
         * var mon = ["Jan","Feb","Mar","Apr"];
         * var index = lfn_IndexOf(mon, "Mar");
         * trace("index==>" + index);	// output : index==>2
         * var index = lfn_IndexOf(mon, "May");
         * trace("index==>" + index);	// output : index==>-1
        */
        lfn_IndexOf = function(array, item, from, strict)
        {
        ...
        ************************************************************************************************/
         ...
         */
        lfn_GetRowType = function (objDs, nRow, bStatusCheck, bFilterCheck)
        {
        	var nRowType;
        	var sStatus;
        	...
        	if (bStatusCheck) {				// STATUS 컬럼으로 체크할지 여부
        		if (bFilterCheck) {
        			sStatus = objDs.getColumnNF(nRow, this.COM_STATUS_ID);
        		} else {
        			sStatus = objDs.getColumn(nRow, this.COM_STATUS_ID);
        		}
        		nRowType = lfn_Decode(sStatus, "C", Dataset.ROWTYPE_INSERT, "U", Dataset.ROWTYPE_UPDATE, "D", Dataset.ROWTYPE_DELETE, Dataset.ROWTYPE_NORMAL);
         ...
         * @return {boolean} 변경여부
         */
        lfn_DsIsUpdated = function (objDs, bStatusCheck, bFilterCheck, bSkipCheck)
        {
        	if (lfn_IsNull(bStatusCheck))		bStatusCheck = true;
        	if (lfn_IsNull(bFilterCheck))		bFilterCheck = false;
        	if (lfn_IsNull(bSkipCheck))			bSkipCheck = true;
        	...
        	if (bStatusCheck) {			// STATUS 컬럼으로 체크할지 여부
        		...
        		if (bSkipCheck) {
        			for (var i = 0 ; i < nRowCnt ; i++) {
        				nRowType = lfn_GetRowType(objDs, i, bStatusCheck, bFilterCheck);
        			...
        			for (var i = 0 ; i < nRowCnt ; i++) {
        				if (lfn_IsUpdatedRow(objDs,i,bStatusCheck,bFilterCheck,bSkipCheck)) {
        					return true;
        				}
        			}
        		}
         ...
         */
        lfn_IsUpdatedRow = function (objDs, nRow, bStatusCheck, bFilterCheck, bSkipCheck)
        {
        	if (lfn_IsNull(bStatusCheck))		bStatusCheck = true;
        	if (lfn_IsNull(bSkipCheck))			bSkipCheck = false;
        	if (lfn_IsNull(bFilterCheck))		bFilterCheck = false;

        	var nRowType;

        	if (objDs.updatecontrol == true && bStatusCheck == false && bSkipCheck == false) {
        		nRowType = lfn_GetRowType(objDs, nRow, bStatusCheck, bFilterCheck);
        		...
        		for (var i = 0, s = objDs.getColCount(); i < s; i++) {
        			if (lfn_IsUpdateColumn(objDs, nRow, objDs.getColID(i), bStatusCheck, bFilterCheck, bSkipCheck) == true) {
        				return true;
        			}
        		}
        	}
         ...
         */
        lfn_IsUpdateColumn = function (objDs, nRow, Column, bStatusCheck, bFilterCheck, bSkipCheck)
        {
        	if (lfn_IsNull(bSkipCheck))			bSkipCheck = false;
        	if (lfn_IsNull(bFilterCheck))		bFilterCheck = false;
        	...
        	var nRowType = lfn_GetRowType(objDs, nRow, bStatusCheck, bFilterCheck);

        	if (bFilterCheck) {
        		if (nRowType == 2) {
        			if (lfn_IsNull(objDs.getColumnNF(nRow, Column))) {
        				return false;
        			}
        		} else {
        		...
        		if (nRowType == 2) {
        			if (lfn_IsNull(objDs.getColumn(nRow, Column))) {
        				return false;
        			}
        		} else {
        ...
        ************************************************************************************************/
         ...
         */
        lfn_IsDate = function(strDate)
        {
        	if (lfn_IsNull(strDate)) return false;

        	var retVal;
        	switch(strDate.length)
        	{
        		case 6://년월
        			retVal =  lfn_IsYM(strDate);
        			break;
        		case 8://년월일
        			retVal =  lfn_IsYMD(strDate);
        			break;
        		default:
        			retVal = false;
        			break;
         ...
         */
        lfn_IsYMD = function(strDate)
        {
        	var retVal = lfn_GetDigit(strDate);
        	...
        	var nLastDay = Number(lfn_GetLastDate(strYM).substr(6,2));//lfn_GetLastDay에서 전체 20170331값이 넘어와서 .substr(6,2)추가 20170313
         ...
         */
        lfn_GetDate = function(sGubn)
        {
        	if(lfn_IsNull(sGubn)) sGubn = "date";
        	var d = new Date();
         ...
         */
        lfn_GetLastDate = function(strDate)
        {
        	var s = "";
            if (strDate == null) {
         ...
         * @return {String} date
         */
        lfn_GetFirstDate = function(strDate)
        {
            var s = "";
         ...
         */
        lfn_GetDiffDate = function(sStartDate, sEndDate)
        {
         ...
         */
        lfn_GetDiffMonth = function(sStartDate, sEndDate)
        {
         ...
         */
        lfn_AddDate = function(strDate, nOffSet)
        {
        	var date = new Date();
         ...
         */
        lfn_LastDate = function(sDate)
        {
            if (lfn_IsNull(sDate)){
                return "";
            }

            var nLastDate = lfn_LastDateNum(sDate);
         ...
         */
        lfn_LastDateNum = function(strMonth)
        {
        	var iLastDay;
         ...
         * @return {String} date
         */
        lfn_AddMonth = function(strDate, OffSet)
        {
        	var date, d, s, mon, val;

        	var sMonthLastDate = lfn_LastDate(strDate);
        	    sMonthLastDate = sMonthLastDate.substr(6);

            if (strDate) {
                date = lfn_StrToDate(strDate);
                d = (new Date(date)).addMonth(OffSet);
            } else {
            	date = lfn_StrToDate(lfn_GetDate());
        		d = (new Date(date)).addMonth(OffSet);
            }
            ...
            if (sMonthLastDate == date.getDate()) {
            	...
            	var ld = new Date((new Date(d)).getFullYear()
            			, (new Date(d)).getMonth()
            			, lfn_LastDate(lfn_DateToStr(new Date(d))).substr(6));
         ...
         * @example :
         */
        lfn_GetHolidays = function(nYear)
        {
        	var nYear;
        	...
        	/////// 음력 체크
        	// 구정
        	aHoliday[0] = lfn_LunarToSolar((nYear-1) + "1230", false) + "설날";
        	aHoliday[1] = lfn_AddDate(aHoliday[0].substring(0, 8), 1) + "설날";
        	aHoliday[2] = lfn_AddDate(aHoliday[1].substring(0, 8), 1) + "설날";
        	// 석가탄신일
        	aHoliday[3] = lfn_LunarToSolar(nYear + "0408", false) + "석가탄신일";
        	// 추석
        	aHoliday[4] = lfn_LunarToSolar(nYear + "0814", false) + "추석";
        	aHoliday[5] = lfn_AddDate(aHoliday[4].substring(0, 8), 1) + "추석";
        	aHoliday[6] = lfn_AddDate(aHoliday[5].substring(0, 8), 1) + "추석";
         ...
         * trace(str); // output : 020130220
         */
        lfn_SolarToLunar =  function(value)
        {
         ...
         */
        lfn_LunarToSolar = function(value, leapMonth)
        {
         ...
         */
        lfn_GetWeek = function(strDate)
        {
        	if (strDate.length != 8 || !lfn_IsDigit(strDate)) {
        		return "";
        	}
         ...
         * @example
         * var dt = lfn_StrToDate("20130430123412"); // convert Date type from "20130430123412".
         * trace(lfn_GetMaskFormatString(dt, "yyyy년 MM월 dd일 tt hh시 mm분 ss초")); // output : 2013년 04월 30일 오후 12시 34분 12초
         * trace(lfn_GetMaskFormatString(dt, "yyyy-MM-dd")); // output : 2013-04-30
         * trace(lfn_GetMaskFormatString(dt, "yy MM.dd")); // output : 13 04.30
         * trace(lfn_GetMaskFormatString(dt, "yyyy-MM-dd W \\Week")); // output : 2013-04-30 18 Week
         * trace(lfn_GetMaskFormatString(dt, "MMMM dddd")); // output : 4월 화요일
         */
        lfn_GetMaskFormatString = function(dt, strMask)
        {
        	if (lfn_IsNull(dt))		return "";

        	if (lfn_TypeOf(dt) == "string") {
        		dt = lfn_StrToDate(dt);
        	}

        	var arrMask = this._lfn_parseDateMask(strMask),
        		arrDt = [], mask, h;
        	...
        	for ( var i = 0, len = arrMask.length; i < len ; i++ )
        	{
        		...
        		else
        		{
        			switch (mask)
        			{
        				...
        				case "W": arrDt[arrDt.length] = new String(lfn_GetWeek(dt)); break;
        			}
        		}
        	}
        	return arrDt.join("");
         ...
         */
        this._lfn_parseDateMask = function(strMask)
        {
         ...
         * @return {String} 8자리 날짜(YYYYMMMDD)문자열
         */
        lfn_GetBirthDateBySSN = function(ssn)
        {
        	var retVal;
         ...
         */
        lfn_GetBirthYear = function(sJuminNo)
        {
         ...
         */
        lfn_GetAge = function(brtYmd, stdYmd)
        {
        	var retVal = -1;

        	if (lfn_IsEmpty(stdYmd)) {
        		stdYmd = lfn__getDate();
        	}

        	if (lfn__isDate(brtYmd) && lfn__isDate(stdYmd)) {
         ...
         * @return Array
         */
        lfn_GetRowDataToArray = function (oData, nRow)
        {
        	if (lfn_IsNull(oData))
        	{
        		return;
         ...
         * @return string
         */
        lfn_GetRowDataToString = function (oData, nRow, sGubn)
        {
        	if (lfn_IsNull(oData))
        	{
        		return;
        ...
        */
        lfn_ObjToDataset = function(object, ds, nRow, bAdd)
        {
        	if (lfn_IsNull(object))		return;
        	if (lfn_IsNull(ds))			return;
        	if (lfn_IsNull(nRow))		nRow = 0;
        	if (lfn_IsNull(bAdd))		bAdd = false;
        ...
        * @param {int} 대상 Row 위치
        */
        lfn_DatasetToObj = function(object, ds, nRow)
        {
        	if (lfn_IsNull(ds))			return;
         ...
         * @return {Array} 컬럼명 배열
         */
        lfn_GetDatasetCols = function(ds)
        {
        ...
        /**
         * @class Object 속성값을 복사해주는 함수
         * @param {object} obj - 복사할 대상 object
         * @return {object} 복사된 object
         * @example
         * var oObjFrom = {"attr1" : "1", "attr2" : "2"}; <br>
         * var objTo = this.fn_CloneObject(oObjFrom);
         */
        lfn_CloneObject = function(obj)
        {
        	...
        	for (var key of Object.keys(obj)) {
        		result[key] = lfn_CloneObject(obj[key])
        	}
