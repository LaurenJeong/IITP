				...
				if (focuspath_index > -1)
                {
					if (focuspath_index == cur_focus_paths.length - 1)
                    {
						...
						else
                        {
							...
							{
								if (this._has_inputElement && this._input_element)
								{
									this._input_element._is_sys_focused = false;
									this._input_element._change_to_keypad_type();
									this._input_element._is_sys_focused = true;
                                }
								return;
                            }
