...
if (!nexacro._CellControl)
{
    ...
    _pCellControl._updateAllEx = function (prop) // for autosize
    {
        if (!this._is_alive)
            return false;
    ...
    _pCellRadioItem._setAccessibilityStatFocus = function ()
    {
        ...
        this._setAccessibilityStatChecked(!!this.value);
        cellobj._setAccessibilityStatChecked(!!this.value);
        nexacro.Component.prototype._setAccessibilityStatFocus.call(this);
    };

    _pCellRadioItem.on_get_accessibility_description = function ()
    {
        if (this._cellobj)
        {
            var tooltiptext = this._cellobj.tooltiptext;
    ...
    _pCellRadioItem.on_get_accessibility_label = function ()
    {
        return "";
    };
