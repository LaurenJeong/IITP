    ...
    */
    ...
    _pDataObject.setDataValue = function (path, value, index, key, srcdsid)
    {
        ...
        if (index == -1)
        {
            ...
            this._before_fire_event = true;
            this.on_fire_onvaluechanged(0, "SUCCESS", 16, /*rowobj,*/ "update_" + parseInt(Math.random() * 100000000),"", index, key, value, srcdsid); //test code
            this._before_fire_event = false;
        }
        else
        {
            ...
            if (rootobj)
            {
                ...
                {
                    //rowobj[key] = value;
                    var uid = "update_" + parseInt(Math.random() * 100000000);
        ...
        {            
            if (data.length > 0)
            {
                ...
                for (var i = 0, len = data.length; i < len; i++)
                {
                    ...
                    updatalist.push({ "uid": type + "_" + parseInt(Math.random() * 100000000), "type": type, "index": index, "data": obj, "dataobjectpath": path, "sourcedatasetid": sourcedatasetid });
                }
            }
            else
            {            
                ...
                this._updatelist.push({ "uid": "update" + "_" + parseInt(Math.random() * 100000000), "type": "update", "index": index, "data": rowobj, "dataobjectpath": path, "sourcedatasetid": sourcedatasetid });
            }
            if (this.enableevent)
            {
                this._before_fire_event = true;
    ...
    _pDataObject.addDataInPath = function (path, data, index, srcdsid)
    {
        ...
        if (rootobj)
        {
            ...
            this._updatelist.push({ "uid": "add" + "_" + parseInt(Math.random() * 100000000), "type": "add", "index": index, "data": rowobj, "dataobjectpath": path, "sourcedatasetid": srcdsid });
    ...
    _pDataObject.deleteDataInPath = function (path, data, index, srcdsid)
    {
        ...
        if (rootobj)
        {
            ...
            this._updatelist.push({ "uid": "delete" + "_" + parseInt(Math.random() * 100000000), "type": "delete", "index": index, "data": rowobj, "dataobjectpath": path, "sourcedatasetid": srcdsid });
            if (this.enableevent && rowobj)
            {
                this._before_fire_event = true;
                this.on_fire_ondatachanged(0, "SUCCESS", 1, this._updatelist); //test code
    ...
    _pDataObject.insertDataInPath = function (path, data, index, srcdsid)
    {
        ...
        {
            var rowobj = this._addRowData(path, data, index);
            this._updatelist.push({ "uid": "insert" + "_" + parseInt(Math.random() * 100000000), "type": "insert", "index": index, "data": rowobj, "dataobjectpath": path, "sourcedatasetid": srcdsid });
            if (this.enableevent && rowobj)
            {
                this._before_fire_event = true;
                this.on_fire_ondatachanged(0, "SUCCESS", 1, this._updatelist); //test code
    ...
    _pDataObject.setData = function (path, type, index, data, srcdsid)
    {
        ...
        this._updatelist.push({ "uid": type + "_" + parseInt(Math.random() * 100000000), "type": type, "index": index, "data": data, "dataobjectpath": path, "srcdatasetid": srcdsid });
        if (this.enableevent && rowobj)
        {
            this._before_fire_event = true;
            this.on_fire_ondatachanged(0, "SUCCESS", 1, this._updatelist); //test code
    ...
    _pDataObject.setDataList = function (path, datalist, srcdsid)
    {
        ...
        if (rootobj)
        {
            for (var i = 0, len = datalist.length; i < len; i++)
            {
                ...
                //if (this.updatecontrol)
                updatalist.push({ "uid": type + "_" + parseInt(Math.random() * 100000000), "type": type, "index": index, "data": obj, "dataobjectpath": path, "srcdatasetid": srcdsid });
                if (this.enableevent)
                    bfire = true;
            }
        }
