...
*/
    ...
    */
    ...
    {
        //trace("onextmodule", this._device_adaptor_handlelist, handle, this._device_adaptor_handlelist.length);
        var ret;        
    ...
    /*
    _pEnvironment._on_onextendedcommand = function (handle, eventtype, data)
    {
        trace("_on_onextendedcommand", this._device_adaptor_handlelist,handle);
        var ret;
        if (this._device_adaptor_handlelist[handle])
        {
            trace("a");
            ret = this._device_adaptor_handlelist[handle].processEvent(eventtype, data);
        }
        return ret;			
    };
    */
