...
if (!nexacro.Edit)
{
    ...
    _pEdit.on_keydown_basic_action = function (keycode, alt_key, ctrl_key, shift_key, refer_comp, meta_key)
    {
        ...
        if (input_elem)
        {         
            if (!this.on_keydown_basic_before_process.call(this, keycode, alt_key, ctrl_key, shift_key, meta_key)) return;
            if (!this.on_keydown_basic_specialkey_process.call(this, keycode, alt_key, ctrl_key, shift_key, meta_key)) return;
