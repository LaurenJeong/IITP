...
if (!nexacro.FileUpload)
{
    ...
    _pFileUploadItemButtonControl.on_fire_sys_onkeyup = function (key_code, alt_key, ctrl_key, shift_key, from_comp, from_refer_comp, meta_key) //  override for keyup 'enter' or 'space'
    {
