...
if (!nexacro.Component)
{
	...
	_pComponent._initComponent = function ()				// init 공통
	{
	...
	_pComponent._InitManagerObject = nexacro._emptyFn;		// 각 Component 환경에 맞게 사용
	_pComponent._InitCollectionObject = nexacro._emptyFn;	// 각 Component 환경에 맞게 사용
	_pComponent._initStatus = function ()					// 각 Component 환경에 맞게 설정
	{
		this._makeStatusMap();
	};				
	_pComponent._initProperties = nexacro._emptyFn;			// 각 Component 환경에 맞게 사용
	...
	_pComponent._clearManagerObject = nexacro._emptyFn;			// 각 Component 환경에 맞게 사용
	_pComponent._clearCollectionObject = nexacro._emptyFn;		// 각 Component 환경에 맞게 사용
