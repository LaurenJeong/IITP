...
if (nexacro.CheckBoxSet)
{
    ...
    _pCheckBoxSet._skip_mobile_tabfocus = true;
    ...
    _pCheckBoxSet.set_itemaccessibilityenable = function (accessibilityenable)
    {
        var accenable = nexacro._toBoolean(accessibilityenable);
        if (this.itemaccessibilityenable != accenable)
        {
    ...
    _pCheckBoxSet.on_apply_prop_itemaccessibilityenable = function ()
    {
        var items = this._items;
        var item_len = items.length;
        this._block_read_aria_stat = this.itemaccessibilityenable == false ? true : false;
