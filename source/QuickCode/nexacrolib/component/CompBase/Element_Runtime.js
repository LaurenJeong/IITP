    ...
    if (!nexacro.Element)
    {
        ...
        */
        ...
        _pControlElement.setLinkedControl = function (control)
        {
            if (!this.linkedcontrol && control)
            {
                ...
                if (control._is_control_component)
                {
                    this.id = control.parent.id;
                    this.name = control.parent._unique_id;
                }
                else
                {
                    this.id = control.id;
        ...
        */
        ...
        _pScrollableControlElement.create = function (win)
        {
            ...
            if (!this._is_popup)
            {
                // genie : ctrlobj._control_element가 destroy 되면서 AC._control elemenet의 parent_elem 이 null이 되는 경우
                // MLM에서 destroy 되는데 어떤 원리지 ?
